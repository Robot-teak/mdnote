...
chrome.runtime.onMessage.addListener(
  (
    ...
    switch (msg.type) {
      ...
      case MessageType.FETCH_RELEASES: {
        // Proxy GitHub API request from extension page → service worker.
        // Service workers have unrestricted network access with host_permissions.
